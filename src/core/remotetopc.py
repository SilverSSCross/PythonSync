...
def remotetopc_funciton(config_file):
    ...
    for directory in values:
        ...
        if not Path(directory).exists():
            ...
            list_copied_files=file_organizer.copy_files(directory, local_directory, "mp3")
            list_deleted_files=file_organizer.delete_files(directory, local_directory, "mp3")
